// ontrol the behaviour of the library and specify custom authentication logic, adapters, etc.
  ...
  providers: [
    Nodemailer({
      server: {
        ...
        port: process.env.EMAIL_SERVER_PORT, // num. of ports 65000 - 65535, TCP/UDP 
        auth: {
